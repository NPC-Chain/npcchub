...
func DelAccumInvariants(k Keeper, sk StakeKeeper) sdk.Invariant {
	...
	return func(ctx sdk.Context) (err error) {
		...
		iterVal := func(_ int64, vdi ValidatorDistInfo) bool {
		...
		iterDel := func(_ int64, ddi DelegationDistInfo) bool {
...
func CanWithdrawInvariant(k Keeper, sk StakeKeeper) sdk.Invariant {
	return func(ctx sdk.Context) (err error) {
		...
		vdiIter := func(_ int64, valInfo ValidatorDistInfo) (stop bool) {
		...
		ddiIter := func(_ int64, distInfo DelegationDistInfo) (stop bool) {
