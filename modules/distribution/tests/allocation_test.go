...
func TestAllocateTokensBasic(t *testing.T) {
	...
	totalPower := int64(10)
	totalPowerDec := sdk.NewDecFromInt(sdk.NewIntWithDecimal(totalPower, 18))
	msgCreateValidator := stake.NewTestMsgCreateValidator(valOpAddr1, valConsPk1, sdk.NewIntWithDecimal(totalPower, 18))
