...
func TestInitGenesis(t *testing.T) {
	...
	validators[0].Tokens = sdk.NewDecFromInt(sdk.NewIntWithDecimal(1, 18))
	validators[0].DelegatorShares = sdk.NewDecFromInt(sdk.NewIntWithDecimal(1, 18))
...
func TestInitGenesisLargeValidatorSet(t *testing.T) {
	...
	for i := range validators {
		...
		if i < 100 {
			validators[i].Tokens = sdk.NewDecFromInt(sdk.NewIntWithDecimal(2, 18))
			validators[i].DelegatorShares = sdk.NewDecFromInt(sdk.NewIntWithDecimal(2, 18))
		} else {
